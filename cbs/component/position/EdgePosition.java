...
public class EdgePosition implements Position {
  ...
  private EdgePosition(@NotNull final Apex first, @NotNull final Apex second) {
  ...
  @NotNull
  public static EdgePosition newInstance(@NotNull final Apex first,
    ...
    return new EdgePosition(first, second);
  }
  ...
  public boolean equals(Object o) {
    ...
    EdgePosition other = (EdgePosition) o;
